...
mod tests {
    ...
    fn test_block() -> anyhow::Result<()> {
        ...
        assert_eq!(
            StateHash::from(protocol_state.t.t.previous_state_hash).to_base58_string(),
            "3NKDdX6eVtAgmmTVxaFLnnPPrsGKgVepG2k5cf8HocgSw6ps8Sww"
        );

        let body = &et.0.t.protocol_state.t.t.body;
        assert_eq!(
            StateHash::from(body.t.t.genesis_state_hash).to_base58_string(),
        ...
        assert_eq!(
            LedgerHash::from(non_snark.ledger_hash).to_base58_string(),
        ...
        assert_eq!(
            AuxHash::from(non_snark.aux_hash.t).to_base58_string(),
        ...
        assert_eq!(
            PendingCoinbaseAuxHash::from(non_snark.pending_coinbase_aux.t).to_base58_string(),
        ...
        assert_eq!(
            SnarkedLedgerHash::from(blockchain_state.t.t.snarked_ledger_hash).to_base58_string(),
            "jxkQm8ge9sYPwPyUYUMZ6wr7SQ6Pit5szbRvPmEzYKQQZAnACyC"
        );
        assert_eq!(
            LedgerHash::from(blockchain_state.t.t.genesis_ledger_hash).to_base58_string(),
        ...
        assert_eq!(*consensus_state.t.t.curr_global_slot.slot_number, 111965);
        assert_eq!(*consensus_state.t.t.curr_global_slot.slots_per_epoch, 7140);
        ...
        assert_eq!(*next_epoch_data.t.t.epoch_length, 3285);

        assert_eq!(consensus_state.t.t.has_ancestor_in_same_checkpoint_window, true);
        assert_eq!(
            consensus_state.t.t.block_stake_winner.t.t.to_base58_string(),
            "B62qmsYXFNNE565yv7bEMPsPnpRCsMErf7J2v5jMnuKQ1jgwZS8BzXS"
        );
        assert_eq!(
            consensus_state.t.t.block_creator.t.t.to_base58_string(),
            "B62qpge4uMq4Vv5Rvc8Gw9qSquUYd6xoW1pz7HQkMSHm6h1o7pvLPAN"
        );
        assert_eq!(
            consensus_state.t.t.coinbase_receiver.t.t.to_base58_string(),
        ...
        assert_eq!(constants.t.t.k.slots_per_epoch.slots_per_sub_window.delta.genesis_state_timestamp.k.0, 290);
        ...
        assert!(&et.0.t.staged_ledger_diff.t.diff.t.diff_one().is_none());
