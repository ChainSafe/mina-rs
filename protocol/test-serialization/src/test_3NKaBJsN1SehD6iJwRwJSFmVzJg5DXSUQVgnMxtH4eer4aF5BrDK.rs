...
mod tests {
    ...
    fn test_block() -> anyhow::Result<()> {
        ...
        */
        ...
        assert!(&StagedLedgerDiff::from(et.0.t.staged_ledger_diff.clone())
            .diff_one
            .is_none());
        let commands = StagedLedgerDiff::from(et.0.t.staged_ledger_diff.clone())
            .diff_two
            .commands
            .clone();
        ...
        let coinbase = StagedLedgerDiff::from(et.0.t.staged_ledger_diff.clone())
            .diff_two
            .coinbase
            .clone();
        match coinbase {
        ...
        let internal_commands = StagedLedgerDiff::from(et.0.t.staged_ledger_diff.clone())
            .diff_two
