    ...
    if height == 0 {
        ...
        *EMPTY_HASH.get_or_init(|| {
            /*
                ...
                radix 10: 1882552903910556352860610796865086976240240506644984541816763961450162122135
                hex:      0x4297cb81a0f3d013341851725ae759ba1fbd8faba27614a7a3abeae29e16d97
            */
            const DEFAULT_HASH: BigInteger256 = BigInteger256::new([
                8807561676512652695,
                11672161430637338954,
                3693379503883449755,
                299907980349881601,
            ]);
            DEFAULT_HASH.into()
