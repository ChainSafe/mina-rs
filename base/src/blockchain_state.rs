...
impl From<BlockchainStateLegacy> for BlockchainState {
    fn from(t: BlockchainStateLegacy) -> BlockchainState {
        BlockchainState {
            staged_ledger_hash: t.staged_ledger_hash,
            genesis_ledger_hash: t.genesis_ledger_hash,
            registers: BlockchainStateRegisters {
                ...
                local_state: BlockchainStateRegistersLocalState {
                    ...
                    ledger: LedgerHash::from_str(
                        "jw6bz2wud1N6itRUHZ5ypo3267stk4UgzkiuWtAMPRZo9g4Udyd",
                    )
                    .unwrap(),
                    success: true,
