...
#[serde(from = "wire::ProtocolStateProof")]
#[serde(into = "wire::ProtocolStateProof")]
pub struct ProtocolStateProof(ProverProof<Vesta>);

impl From<wire::ProtocolStateProof> for ProtocolStateProof {
    fn from(_: wire::ProtocolStateProof) -> Self { todo!() }
}

impl From<ProtocolStateProof> for wire::ProtocolStateProof {
