...
use crate::network_types::proof_messages::ProofMessagesV1;

use crate::network_types::proof_evaluations::ProofEvaluationsV1;

use crate::network_types::opening_proof::OpeningProofV1;

use crate::network_types::bulletproof_challenges::{
...
use crate::network_types::field_and_curve_elements::{
    FiniteECPoint, FiniteECPointVecV1,
};
...
pub type ProtocolStateProofV1 = Versioned<Versioned<Versioned<Versioned<ProtocolStateProof, 1>, 1>, 1>, 1>;
...
pub type SpongeDigestBeforeEvaluationsV1 = Versioned<Versioned<SpongeDigestBeforeEvaluations, 1>, 1>;
